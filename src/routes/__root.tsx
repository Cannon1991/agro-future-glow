...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AgroPulse Fix — AI Digital Agriculture for Nigeria & Beyond" },
      { property: "og:description", content: "AgroPulse Fix uses satellite data, weather models and AI to map parcels, detect crop disease early, optimize fertilizer use and boost yields for farmers and governments." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "AgroPulse Fix" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "AgroPulse Fix — AI Digital Agriculture for Nigeria & Beyond" },
